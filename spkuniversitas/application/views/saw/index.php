    ...
    <div class="row">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <h2>Table 4 - Dijumlah sesuai dengan saham dan di dapat hasil rangking</h2>
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        <tr class="active">
                            <th class="col-md-1 text-center">No</th>
                    ...
                    if ($value->Rangking == 1) {
                        ...
                        <div class="alert alert-success" role="alert">
                            <h4><b>Kesimpulan : </b> Dari hasil perhitungan yang dilakukan menggunakan metode SAW
                                saham prima terbaik untuk di pilih adalah
                                <?php echo $value->Saham ?> dengan nilai <?php echo $value->Total ?>
                            </h4>
                        </div>
                        <?php
                    }
